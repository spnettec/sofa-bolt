...
import com.alipay.sofa.common.log.ClassUtil;
...
public final class LogEnvUtils {
    ...
    public static Map<String, String> processGlobalSystemLogProperties() {
        ...
        } else if (!StringUtils.isBlank(loggingRoot)) {
            loggingPath = loggingRoot;
        }

        if (StringUtils.isNotEmpty(loggingPath)) {
    ...
    public static String getLogConfEnvSuffix(String spaceName) {
        String logEnvConfig = System.getProperty(LOG_ENV_SUFFIX, StringUtils.EMPTY);
