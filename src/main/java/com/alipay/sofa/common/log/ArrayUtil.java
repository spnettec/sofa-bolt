        ...
        if (array != null && arrayToFind != null) {
            ...
            if (startIndex >= sourceLength) {
                ...
                if (targetLength == 0) {
                    ...
                    while (true) {
                        while (i > max || ArrayUtil.equals(array[i], first)) {
                            if (i > max) {
                                return -1;
                            }
                            ...
                            } while (ArrayUtil.equals(array[j++], arrayToFind[var10++]));
        ...
        if (array != null && arrayToFind != null) {
            ...
            if (startIndex < 0) {
                ...
                if (targetLength == 0) {
                    ...
                    while (true) {
                        while (i < min || ArrayUtil.equals(array[i], last)) {
                            if (i < min) {
                                return -1;
                            }
                            ...
                            } while (ArrayUtil.equals(array[j--], arrayToFind[var12--]));
